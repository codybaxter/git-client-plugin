        ...
        return new SubmoduleUpdateCommand() {
            ...
            public void execute() throws GitException, InterruptedException {
                ...
                for (IndexEntry submodule : submodules)
                {
                    ...
                    //listener.error("launchCommandWithCredentials");
                    if (submoduleArgs != null) listener.error("submoduleArgs: " + submoduleArgs);
                    if (cred != null) listener.error("cred: " + cred.toString());
                    if (submoduleUrl != null) listener.error("submoduleUrl: " + submoduleUrl);
                    ...
                    listener.error("cred after searching: ");
                    listener.error(cred == null ? "null" : cred.toString());
            ...
            private StandardCredentials getCredentials(String url)
            {
                ...
                {
                    String testUrl = shortUrl(cred.getKey());
                    listener.error("Testing url: " + testUrl == null ? "null" : testUrl + " for shortenedUrl: " + shortenedUrl);
                    if (testUrl == shortenedUrl)
                    {
